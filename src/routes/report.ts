...
import { compressMultipleImages } from '../middleware/imageProcessing';
 ...
 * POST /api/reports
 */
router.post('/', authenticateToken, requireActiveUser, upload.array('images', 5), compressMultipleImages, async (req: Request, res: Response) => {
  try {
