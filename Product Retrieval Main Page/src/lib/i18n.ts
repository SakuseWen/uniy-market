...
export const translations = {
  en: {
    ...
    eduRevoked: 'Your education verification has been revoked by an administrator. Please contact the admin for assistance.',
  ...
  zh: {
    ...
    eduRevoked: '您的教育认证已被管理员撤销，请联系管理员处理。',
  ...
  th: {
    ...
    chatDeleted: 'ลบประวัติการสนทนาสำเร็จ',
    ...
    eduRevoked: 'การยืนยันการศึกษาของคุณถูกเพิกถอนโดยผู้ดูแลระบบ กรุณาติดต่อผู้ดูแลระบบ',
