...
const DealModel_1 = require("../../src/models/DealModel");
...
describe('DealModel', () => {
    ...
    beforeAll(async () => {
        ...
        dealModel = new DealModel_1.DealModel();
    ...
    describe('getDealsByBuyer', () => {
        it('should get all deals for a buyer', async () => {
            ...
            expect(deals.every((d) => d.buyerID === buyer.userID)).toBe(true);
        });
    });
    describe('getDealsBySeller', () => {
        it('should get all deals for a seller', async () => {
            ...
            expect(deals.length).toBeGreaterThan(0);
            expect(deals.every((d) => d.sellerID === seller.userID)).toBe(true);
        });
    });
    ...
    describe('getDealsByListing', () => {
        it('should get all deals for a product listing', async () => {
            ...
            expect(deals.length).toBeGreaterThan(0);
            expect(deals.every((d) => d.listingID === product.listingID)).toBe(true);
        });
    });
    describe('updateDealStatus', () => {
        ...
        it('should throw error for non-existent deal', async () => {
            await expect(dealModel.updateDealStatus('non_existent_id', 'completed')).rejects.toThrow();
        });
    });
    describe('updateDeal', () => {
