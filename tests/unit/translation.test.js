...
describeIfApiKey('TranslationService - Integration Tests', () => {
    ...
    describe('translateText', () => {
        it('should translate text from English to Chinese', async () => {
            ...
            const result = await TranslationService_1.default.translateText(text, 'zh');
        ...
        it('should translate text from English to Thai', async () => {
            ...
            const result = await TranslationService_1.default.translateText(text, 'th');
            expect(result).toBeDefined();
            expect(result.translatedText).toBeDefined();
            expect(result.translatedText.length).toBeGreaterThan(0);
        ...
        it('should translate text from Chinese to English', async () => {
            const text = '你好，世界！';
            const result = await TranslationService_1.default.translateText(text, 'en', 'zh');
            expect(result).toBeDefined();
            expect(result.translatedText).toBeDefined();
            expect(result.translatedText.length).toBeGreaterThan(0);
        ...
        it('should translate text from Thai to English', async () => {
            ...
            const result = await TranslationService_1.default.translateText(text, 'en', 'th');
            expect(result).toBeDefined();
            expect(result.translatedText).toBeDefined();
            expect(result.translatedText.length).toBeGreaterThan(0);
            expect(result.targetLanguage).toBe('en');
        ...
        it('should auto-detect source language when not specified', async () => {
            ...
            const result = await TranslationService_1.default.translateText(text, 'en');
            expect(result).toBeDefined();
            expect(result.translatedText).toBeDefined();
            expect(result.sourceLanguage).toBeDefined();
        ...
        it('should use cache for repeated translations', async () => {
            ...
            const result1 = await TranslationService_1.default.translateText(text, 'zh');
            // Second translation - should use cache / 第二次翻译 - 应该使用缓存
            const result2 = await TranslationService_1.default.translateText(text, 'zh');
    ...
    describe('detectLanguage', () => {
        it('should detect English language', async () => {
            ...
            const result = await TranslationService_1.default.detectLanguage(text);
            expect(result).toBeDefined();
    ...
    describe('translateBatch', () => {
        it('should translate multiple texts', async () => {
            ...
            const results = await TranslationService_1.default.translateBatch(texts, 'zh');
        ...
        it('should handle mixed language texts', async () => {
            ...
            const results = await TranslationService_1.default.translateBatch(texts, 'en');
            expect(results).toBeDefined();
            expect(results.length).toBe(3);
            results.forEach(result => {
                expect(result).toBeDefined();
        ...
        it('should use cache for batch translations', async () => {
            ...
            const results1 = await TranslationService_1.default.translateBatch(texts, 'zh');
            // Second batch translation - should use cache / 第二次批量翻译 - 应该使用缓存
            const results2 = await TranslationService_1.default.translateBatch(texts, 'zh');
    ...
    describe('Cache Management', () => {
        it('should clear cache', async () => {
            ...
            await TranslationService_1.default.translateText('Hello', 'zh');
            await TranslationService_1.default.translateText('World', 'zh');
            let stats = TranslationService_1.default.getCacheStats();
            expect(stats.size).toBeGreaterThan(0);
            // Clear cache / 清除缓存
            TranslationService_1.default.clearCache();
            stats = TranslationService_1.default.getCacheStats();
        ...
        it('should increment cache size when adding translations', async () => {
            const initialStats = TranslationService_1.default.getCacheStats();
            const initialSize = initialStats.size;
            await TranslationService_1.default.translateText('Hello', 'zh');
            const newStats = TranslationService_1.default.getCacheStats();
    ...
    describe('Edge Cases', () => {
        it('should handle very long text', async () => {
            ...
            const result = await TranslationService_1.default.translateText(longText, 'zh');
            expect(result).toBeDefined();
            expect(result.translatedText).toBeDefined();
            expect(result.translatedText.length).toBeGreaterThan(0);
        }, 15000);
        ...
        it('should handle same source and target language', async () => {
            const text = 'Hello, world!';
            const result = await TranslationService_1.default.translateText(text, 'en', 'en');
            expect(result).toBeDefined();
            expect(result.translatedText).toBeDefined();
